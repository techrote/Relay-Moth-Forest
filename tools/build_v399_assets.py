...
def main():
    ...
    m['schema']='relay-moth-hd-atlas/v3.99';m['image']='assets/sprite_runtime_atlas.png';m['bump_image']='assets/sprite_bumpmap.png';m['source_size']=list(size);m['regions']={n:list(v) for n,v in pos.items()}
    ...
    sm={'schema':'relay-moth-sprite-sheets/v3.99','grid_px':16,'categories':{},'notes':['Runtime sheets transparent; edit grids contain 16px guides, region outlines, names and coordinates.','Foliage, trees and creatures have dedicated external-edit sheets in v3.99.']}
    ...
    print('v3.99 atlas',size,'regions',len(sprites),'foliage',len(new_f),'trees',len(new_t),'creatures',len(creature_roles))

if __name__=='__main__':
    main()
    from append_v39952_bridge_assets import main as append_bridge_assets
    append_bridge_assets()

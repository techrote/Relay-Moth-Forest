...
assert 'grassQuality:3' in js and 'grassDensity:2.35' in js
...
assert 'relayMothGraphics39955' in js and 'raw39954' in js and 'raw39953' in js and 'raw39952' in js
...
print('VISUAL / BEHAVIOR REGRESSION 3.995.5 PASS')

...
hd=json.loads((R/'hd_remake_atlas.json').read_text());assert hd['roles']['bridge']['deck']=='bridge_deck_tile';assert hd['roles']['bridge']['island']=='bridge_island_tile';assert hd['region_meta']['bridge_deck_tile'].get('material')=='wood'
...
print('TIN STREAM BRIDGE REGRESSION 3.995.3 PASS')
print('  wooden bridge sprites + four-row crossing + staged water authority validated')
